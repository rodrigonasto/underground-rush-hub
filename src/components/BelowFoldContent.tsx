      ...
      <section id="comparativo" className="px-5 py-14">
        <div className="container max-w-lg mx-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group w-full mt-6 inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground font-bold text-sm px-6 py-4 rounded-xl hover:brightness-110 transition-all glow-primary"
          >
            <Zap className="w-4 h-4 flex-shrink-0" />
            <span className="uppercase tracking-wide">INSTALAR EM 1 CLIQUE</span>
            <ChevronRight className="w-4 h-4 flex-shrink-0 transition-transform group-hover:translate-x-0.5" />
          ...
          <div className="rounded-2xl p-6 sm:p-8 text-center relative overflow-hidden" style={{ background: "linear-gradient(180deg, hsl(142 72% 50% / 0.06), hsl(150 6% 8%))" }}>
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <span className="text-[10px] font-normal text-foreground">+100 jogos prontos para jogar no celular</span>
              </a>
